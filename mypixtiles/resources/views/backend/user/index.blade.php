		...
		<div class="mr-auto">
			...
			<ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
				...
				<li class="m-nav__item">
					<a href="#"><span class="m-nav__link-text">User Management</span></a>
				</li>
			</ul>
		</div>
	</div>
		...
		<div class="m-portlet__head">
			<div class="m-portlet__head-caption">
				<div class="m-portlet__head-title">
					...
					<a href="{{url('user/index')}}" class="btn btn-primary" style="    margin-left: 10px;
">Reset</a>
				</div>
			</div>
		</div>
			...
			<table class="table table-striped- table-bordered table-hover table-checkable" id="m_table_2">
				<thead class='m-datatable__head'>
					<tr class="m-datatable__row">
						...
						<th class='m-datatable__cell--center m-datatable__cell m-datatable__cell--check'>Email</th>
