		...
		<div class="m-portlet__head">
			<div class="m-portlet__head-caption">
				<div class="m-portlet__head-title">
					<a href="{{url('site-configuration/create')}}"><button type="button" class="btn btn-primary">Add Site Configuration</button></a>
					<a href="{{url('site-configuration/index')}}"  id='reset'  class="btn-space"><button type="button" class="btn btn-primary">Reset</button></a>
				</div>
			</div>
		</div>
...
<script>
	$(function() {
	    var siteconfig_table = $('#m_table_2').DataTable({
	        ...
	        serverSide: true,
	        order: [ [0, 'desc'] ],
	        ajax: '{!! url('site-configuration/data') !!}',
	        columns: [
	            { data: 'id', name: 'id' },
	            { data: 'config_key', name: 'config_key' },
