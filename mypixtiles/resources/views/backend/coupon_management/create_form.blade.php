	...
	<div class="row">
		<div class="col-lg-12">
			...
			<div class="m-portlet">
				...
				action="{{ url('coupon-management/store')}}" name="content_form" id="content_form" >
					@csrf
					<div class="m-portlet__body">
						<div class="form-group m-form__group row">
							<div class="col-lg-6">
								<label>Coupon Name:</label>
								<input type="text" class="form-control m-input" name="coupon_name" placeholder="Enter coupon name" maxlength='60'>
								<span class="m-form__help error coupon_name"></span>
							</div>
							<div class="col-lg-6">
								<label>Coupon Code:</label>
								<input type="text" class="form-control m-input" name="coupon_code" placeholder="Enter coupon code" maxlength='60'>
						...
						<div class="form-group m-form__group row has-success">
							<div class="col-lg-12">
								...
								<textarea  class="form-control m-input" name="coupon_description" style="resize: none;"></textarea>
						...
						<div class="form-group m-form__group row">
							...
							<div class="col-lg-6">
								...
								<input type="text" class="form-control m-input" name="discount" placeholder="Enter discount" maxlength='60'>
						...
						<div class="form-group m-form__group row">
							<div class="col-lg-6">
								...
								<input type="date" class="form-control m-input" name="start_date" placeholder="start date" maxlength='60'>
								<span class="m-form__help error start_date"></span>
							</div>
							<div class="col-lg-6">
								<label>End date:</label>
								<input type="date" class="form-control m-input" name="end_date" placeholder="End date" maxlength='60'>
