	...
	<div class="row">
		<div class="col-lg-12">
			...
			<div class="m-portlet">
				...
				action="{{ route('content-management.update',$cms_data->id)}}" name="content_form" id="content_form">
					@csrf
					@method('patch')
					<div class="m-portlet__body">
						<div class="form-group m-form__group row">							
							<div class="col-lg-6">
								...
								<input type="text" class="form-control m-input" maxlength='60' readonly name="title" placeholder="Enter title name" value="{{$cms_data->title}}">
						...
						<div class="form-group m-form__group row has-success">
							<div class="col-lg-12 col-md-9 col-sm-12">
								...
								<textarea class="summernote" name="content">{{$cms_data->content}}</textarea>
