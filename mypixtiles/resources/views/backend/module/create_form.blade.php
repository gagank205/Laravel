	...
	<div class="d-flex align-items-center">
		<div class="mr-auto">
			...
			<ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
				...
				<li class="m-nav__item">
					<a href="" class="m-nav__link">
						<span class="m-nav__link-text">Add Module</span>
					</a>
				</li>
			</ul>
		</div>
				...
				action="{{ url('module/store')}}" name="module_form" id="module_form">
					...
					<div class="m-portlet__body">
						<div class="form-group m-form__group row">							
							<div class="col-lg-6">
								<label>Name</label>
								<input type="text" class="form-control m-input" name="module_name" maxlength='65' placeholder="Enter module name">
								<span class="m-form__help error module_name"></span>
							</div>
							<div class="col-lg-6">
								<label>Menu Name</label>
								<input type="text" class="form-control m-input" name="menu_name" maxlength='65' placeholder="Enter menu name">
								<span class="m-form__help error menu_name"></span>
							</div>
							<div class="col-lg-6">
								<label>Icon</label>
								<input type="text" class="form-control m-input" name="icon" maxlength='60' placeholder="Enter module icon">
