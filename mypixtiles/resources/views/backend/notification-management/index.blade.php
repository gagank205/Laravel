...
<div class="m-subheader ">
  ...
  <div class="d-flex align-items-center">
    <div class="mr-auto">
      <h3 class="m-subheader__title m-subheader__title--separator">Notification Management</h3>
      <ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
        ...
        <li class="m-nav__item">
          <span class="m-nav__link-text">Notification Management</span>
        </li>
      </ul>
    </div>
  </div>
  ...
  $(function() {
      var category_table = $('#m_table_2').DataTable({
        lengthMenu:{{env('PAGE_LIST')}},
          ...
          serverSide: true,
          order: [ [0, 'desc'] ],
          ajax: '{!! url('notification-management/data') !!}',
          columns: [
              { data: 'id', name: 'id' },
              { data: 'title', name: 'title' },
              { data: 'description', name: 'description' },
              { data: 'notificaiton_type', name: 'notificaiton_type' },
