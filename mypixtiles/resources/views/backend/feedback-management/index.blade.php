...
@section('content')
  ...
  <div class="d-flex align-items-center">
    <div class="mr-auto">
      <h3 class="m-subheader__title m-subheader__title--separator">Feedback Management</h3>
      <ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
        ...
        <li class="m-nav__item">
          <span class="m-nav__link-text">Feedback Management</span>
        </li>
      </ul>
    </div>
  </div>
      ...
      <table class="table table-striped- table-bordered table-hover table-checkable" id="m_table_2">
        <thead class='m-datatable__head'>
          <tr class="m-datatable__row">
            ...
            <th class='m-datatable__cell--center m-datatable__cell m-datatable__cell--check'>Branch Name</th>
            <th class='m-datatable__cell--center m-datatable__cell m-datatable__cell--check'>Menu</th>
            <th class='m-datatable__cell--center m-datatable__cell m-datatable__cell--check'>FeedBack</th>
            <th style="width: 10%" class='m-datatable__cell--center m-datatable__cell m-datatable__cell--check'>Status</th>
            <th style="width: 22%" class='m-datatable__cell--center m-datatable__cell m-datatable__cell--check'>Actions</th>
          </tr>
        </thead>
      </table>
    </div>
  ...
  $(function() {
      var user_table = $('#m_table_2').DataTable({
        lengthMenu:{{env('PAGE_LIST')}},
          ...
          serverSide: true,
          order: [ [0, 'desc'] ],
          ajax: '{!! url('feedback-management/data') !!}',
          columns: [
              { data: 'id', name: 'id' },
              { data: 'first_name_en', name: 'first_name_en' },
              { data: 'branch_name_en', name: 'branch_name_en' },
              { data: 'cafe_menu_name_en', name: 'cafe_menu_name_en' },
