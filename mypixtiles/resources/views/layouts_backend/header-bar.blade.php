				...
				<div class="m-stack m-stack--ver m-stack--general">
					<div class="m-stack__item m-stack__item--middle m-brand__logo">
						<a href="{{ROUTE('dashboard')}}" class="m-brand__logo-wrapper">
							<!-- <img alt="" class="custom_image" src="{{asset('assets/demo/media/img/logo/i_just_paid_logoNew.png')}}" /> -->
							<h3 class="custom_title">Mypixtiles</h3>
						</a>
					</div>
							 ...
							 m-dropdown-toggle="click">
								<a href="#" class="m-nav__link m-dropdown__toggle">
									<span class="m-topbar__userpic">
										<img src="{{url('media/userimage/',Auth::user()->image)}}" class="m--img-rounded m--marginless" alt="" />
									</span>
											...
											<div class="m-dropdown__content">
												<ul class="m-nav m-nav--skin-light">
													...
													<li class="m-nav__item">
														<a href="{{ROUTE('edit-profile.edit')}}" class="m-nav__link">
