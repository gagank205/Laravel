	...
	<div class="row">
		<div class="col-lg-12">
			...
			<div class="m-portlet">
				...
				action="{{ route('frame-management.update',$cms_data->id)}}" name="content_form" id="content_form" enctype="multipart/form-data" >
					@csrf
					@method('patch')
					<div class="m-portlet__body">
						<div class="form-group m-form__group row">							
							<div class="col-lg-6">
								...
								<input type="text" class="form-control m-input" maxlength='60' name="title" placeholder="Enter title name" value="{{$cms_data->title}}">
						...
						<div class="form-group m-form__group row has-success">
							<div class="col-lg-6">
								...
								<textarea class="form-control m-input" name="description">{{$cms_data->description}}</textarea>
						...
						<div class="form-group m-form__group row">							
							<div class="col-lg-6">
								...
								<input type="file" class="form-control m-input" maxlength='60' name="image" >
								<span class="m-form__help error image"></span>
								<br/>
								<img src="{{url('media/frame/'.$cms_data->frame_image)}}" width="120"  alt="" />
							</div>
						</div>
					</div>
