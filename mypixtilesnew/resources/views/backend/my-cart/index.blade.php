...
<div class="m-subheader ">
  ...
  <div class="d-flex align-items-center">
    <div class="mr-auto">
      <h3 class="m-subheader__title m-subheader__title--separator">My Cart</h3>
      <ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
        ...
        <li class="m-nav__item">
          <span class="m-nav__link-text">My Cart</span>
        </li>
      </ul>
    </div>
  </div>
      ...
      <table class="table table-striped- table-bordered table-hover table-checkable" id="m_table_2">
        <thead>
          <tr>
            ...
            <th style="width: 10%">Food Quantity</th>
  ...
  $(function() {
      var category_table = $('#m_table_2').DataTable({
        lengthMenu:{{env('PAGE_LIST')}},
          ...
          serverSide: true,
          order: [ [0, 'desc'] ],
          ajax: '{!! url('my-cart/data') !!}',
          columns: [
              { data: 'id', name: 'id' },
              { data: 'first_name_en', name: 'first_name_en' },
              { data: 'last_name_en', name: 'last_name_en ' },
              { data: 'branch_name_en', name: 'branch_name_en' },
               { data: 'food_quantity', name: 'food_quantity' },
