@extends('layouts_backend.masters',['title'=>'Edit Profile'])
@section('content')
        ...
        <div class="mr-auto">
            ...
            <ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
                <li class="m-nav__item m-nav__item--home">
                    <a href="{{ROUTE('dashborad')}}" class="m-nav__link m-nav__link--icon">
                        <i class="m-nav__link-icon la la-home"></i>
                    </a>
                </li>               
                <li class="m-nav__item">
                    <a href="" class="m-nav__link">
                        <span class="m-nav__link-text">Profile Management</span>
                    </a>
                </li>
            </ul>
        </div>
                    ...
                    <div class="m-portlet__body">
                        <div class="form-group m-form__group row">                                                      
                            <div class="col-lg-6">
                                ...
                                <input type="password" class="form-control m-input" name="current_password" placeholder="Enter current possword" id="current-password" max='25'>
