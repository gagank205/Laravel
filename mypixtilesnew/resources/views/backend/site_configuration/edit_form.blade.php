	...
	<div class="row">
		<div class="col-lg-12">
			...
			<div class="m-portlet">
				...
				action="{{ route('site-configuration.update',$siteconfig_data->id)}}" name="siteconfig_form" id="siteconfig_form">
					@csrf
					@method('PATCH')
					<div class="m-portlet__body">
						<div class="form-group m-form__group row">
							<div class="col-lg-6">
								...
								<input type="text" class="form-control m-input" maxlength='60' disabled name="config_key" placeholder="Enter config key" value="{{$siteconfig_data->config_key}}">
								<span class="m-form__help error config_key"></span>
							</div>
							<div class="col-lg-6">
								<label>Config Value:</label>
								<input type="text" class="form-control m-input" maxlength='255' name="config_value" placeholder="Enter config key" value="{{$siteconfig_data->config_value}}">
