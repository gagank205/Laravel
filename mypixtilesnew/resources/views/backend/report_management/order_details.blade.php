		...
		<div class="m-portlet__head">
			<table>
				<tr>
					...
					<td><a class="btn btn-warning" href="{{ route('order_export') }}">Export User Data</a></td>
				</tr>
			</table>
			...
			<table class="table table-striped- table-bordered table-hover table-checkable" id="m_table_2">
				<thead class='m-datatable__head'>
					<tr class="m-datatable__row">
						<th style="width: 10%" class='m-datatable__cell--center m-datatable__cell m-datatable__cell--check'>Order ID</th>
						<th class='m-datatable__cell--center m-datatable__cell m-datatable__cell--check'>First Name</th>
						<th class='m-datatable__cell--center m-datatable__cell m-datatable__cell--check'>total amount</th>
						<th style="width: 10%" class='m-datatable__cell--center m-datatable__cell m-datatable__cell--check'>created date</th>
						<th style="width: 10%" class='m-datatable__cell--center m-datatable__cell m-datatable__cell--check'>View Order</th>
					</tr>
				</thead>
			</table>
		</div>
...
<script>
	$(function() {
	    var user_table = $('#m_table_2').DataTable({
	        ...
	        serverSide: true,
	        order: [ [0, 'desc'] ],
	        ajax: '{!! url('report-management/orderDate') !!}',
	        columns: [
	            { data: 'order_id', name: 'order_id' },
	            { data: 'first_name', name: 'first_name' },
	            { data: 'total_amount', name: 'total_amount' },
	            { data: 'created_at', name: 'created_at' },
	            { data: 'view_order', name: 'view_order' }
