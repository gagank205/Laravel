	...
	<div class="row">
		<div class="col-lg-12">
			...
			<div class="m-portlet">
				...
				action="{{ url('userrole/store')}}" name="userrole_form" id="userrole_form">
					@csrf
					<div class="m-portlet__body">
						<div class="form-group m-form__group row">
							<div class="col-lg-6">
								<label>Role:</label>
								 <input type="text" class="form-control m-input" name="name" maxlength='25' placeholder="Enter user role name">
								...
								<label class="m-checkbox m-checkbox--solid m-checkbox--state-brand bold">
									...
									<div class="action_child">
									 <label class="m-checkbox m-checkbox--solid m-checkbox--state-success">
									 	<input type="checkbox" name="action[]" class="action_click_{{$key}} action_" value="{{$val['module_id'].'_'.$value['action_id']}}">{{$value['action_name']}}
									 	<span></span>
									 </label>
									 </div>
									@endforeach
