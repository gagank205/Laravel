...
<div class="m-subheader ">
  ...
  <div class="d-flex align-items-center">
    <div class="mr-auto">
      <h3 class="m-subheader__title m-subheader__title--separator">Category Master</h3>
      <ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
        ...
        <li class="m-nav__item">
          <span class="m-nav__link-text">Category Master</span>
        </li>
      </ul>
    </div>
  </div>
  ...
  $(function() {
      var category_table = $('#m_table_2').DataTable({
        lengthMenu:{{env('PAGE_LIST')}},
          ...
          serverSide: true,
          order: [ [0, 'desc'] ],
          ajax: '{!! url('category-master/data') !!}',
          columns: [
              { data: 'id', name: 'id' },
              { data: 'category_name', name: 'category_name' },
              { data: 'category_description', name: 'category_description' },
              { data: 'lanuage_name', name: 'lanuage_name' },
